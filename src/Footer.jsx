        ...
        return(
          ...
          <div className="container mx-auto px-4 pb-10">
            ...
            <li className="mr-12 mb-2 md:mb-0"><a className="text-sm font-medium"  href="https://www.quotehound.com/terms-conditions" data-config-id="01_link3">Terms & Conditions</a></li>
                  ...
                  <a className="inline-block mr-auto lg:mr-0 py-4 px-8 text-sm text-white font-medium leafing-normal bg-blue-500 hover:bg-blue-300 hover:shadow-lg rounded"  href="tel:18882990019" data-config-id="primary-action">Get Your Free Quote</a>
                </div>
          ...
          <p className="text-sm text-left text-gray-500">Invitations for application for insurance via usahealthquotes.com are made through Quotehound, Inc. or through its designated agent(s), Devanand Gaymes, only where licensed and appointed. License numbers are available here or upon request and are automatically provided where required by law.  Devanand Gaymes is a licensed General Lines Health Insurance agent in the State of Texas. Devanand Gaymes' Texas license number is 1897511</p>
          </div>
