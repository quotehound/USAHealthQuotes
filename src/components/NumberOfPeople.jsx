...
class Household extends Component {
  ...
  const pre = urlParams.get('pre_existing_conditions');
    ...
    this.props.history.push('/height-weight' + '?zip_code=' + zip + '&health_insurance_plan=ACA_Plan' + '&coverage_time=' + time + '&household_income=' + income + '&gender=' + gender + '&pre_existing_conditions=' + pre + '&household_size=' + g);
